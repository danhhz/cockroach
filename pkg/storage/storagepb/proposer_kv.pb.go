...
import fmt "fmt"
import math "math"
import colengine "github.com/cockroachdb/cockroach/pkg/col/colengine"
...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{5}
}
...
type ReplicatedEvalResult struct {
	...
	ColumnarData    *colengine.DeterministicData     `protobuf:"bytes,22,opt,name=columnar_data,json=columnarData,proto3" json:"columnar_data,omitempty"`
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{9}
}
...
func (*RaftCommandFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_49390c14cfe986ee, []int{10}
}
...
func (this *ReplicatedEvalResult) Equal(that interface{}) bool {
	...
	if !this.ColumnarData.Equal(that1.ColumnarData) {
		return false
	}
...
func (m *ReplicatedEvalResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ColumnarData != nil {
		dAtA[i] = 0xb2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProposerKv(dAtA, i, uint64(m.ColumnarData.Size()))
		n17, err := m.ColumnarData.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColumnarData", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ColumnarData == nil {
				m.ColumnarData = &colengine.DeterministicData{}
			}
			if err := m.ColumnarData.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("storage/storagepb/proposer_kv.proto", fileDescriptor_proposer_kv_49390c14cfe986ee)
}

var fileDescriptor_proposer_kv_49390c14cfe986ee = []byte{
	// 1420 bytes of a gzipped FileDescriptorProto
	,
}
